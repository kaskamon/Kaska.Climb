...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // El arranque automático del contrato (fecha de inicio/fin) ya NO se
    // fija aquí al publicar la primera sesión real — ahora se fija al
    // publicar la Batería de test (ver api/bateria-test.js), porque esa
    // prueba inicial se hace antes de empezar a entrenar de verdad y es una
    // fecha de "inicio" más fiel que la primera semana programada.
